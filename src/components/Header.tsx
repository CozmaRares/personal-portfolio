...
const Header = () => (
  <motion.header
    className="fixed left-1/2 top-0 z-10 w-full min-w-[20rem] bg-white/20 p-4 capitalize backdrop-blur neon-indigo-lg dark:bg-gray-950/20 dark:neon-green-lg sm:top-5 sm:w-[39rem] sm:rounded-full"
