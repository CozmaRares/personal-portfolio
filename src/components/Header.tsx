...
const Header = () => (
  <motion.header
    className="z-10 fixed left-1/2 top-0 w-full min-w-[20rem] bg-white/20 p-4 capitalize backdrop-blur neon-indigo-lg dark:bg-gray-950/20 dark:neon-green-lg sm:top-5 sm:w-[39rem] sm:rounded-full"
